...
<body>
    ...
    if($age) {
        ...
        echo "<div id='card'><br></br><p>REGISTRATION SUCCESFULLY DELETED</p><form action='displayusers.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
    
    } else {
        echo "<div id='card'><br></br><p>INVALID USER ID</p><form action='displayusers.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
    }
