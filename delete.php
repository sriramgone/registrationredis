...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="displayusers.php">Home </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <form class="registration-form" action="deleteaction.php" method="POST">
            <label class="">
            ...
            <div class="text-center">
                <button class="submit" name="search" value="submit">DELETE</button>
            </div>
        </form>
    </div>
