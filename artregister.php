...
<body>
    ...
    <div class="container">
        ...
        <form class="registration-form" action="artregister_action.php" method="POST">
            ...
            <label class="label-text">
                <span class="label-text">EVENTS</span>
                    <select name="event" required="required">
                        ...
                        <option value="Art, Dance">Art, Dance</option>
                        <option value="Art, Dance">Coding, Dance</option>
                        <option value="Art, Dance">Coding, Art</option>
                        <option value="Art, Dance &Coding">Art, Dance & Coding</option>
                    </select>
            </label>
            ...
            <div class="text-center">
                <button class="submit" name="register" value="submit">REGISTER</button>
            </div>
        </form>
    </div>
